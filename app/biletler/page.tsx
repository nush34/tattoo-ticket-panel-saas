...
function TicketImageCard({ rawImageUrl, onPreview }: TicketImageCardProps) {
    ...
    <div className="lg:w-44 shrink-0">
      ...
      >
        {imageUrl ? (
          ...
          <div className="flex h-44 w-full lg:w-44 items-center justify-center rounded-3xl border border-white/10 bg-black/30 text-xs text-zinc-500">
            Görsel yükleniyor
          </div>
        )}
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col lg:flex-row gap-4">
                      <TicketImageCard
                        rawImageUrl={ticket.dovme_gorseli_url}
